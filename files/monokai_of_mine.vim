" File:       monokai_of_mine.vim
" Note:       This is my private version of the original, 
"               I only adapted some parts I didn't like
"               The real hero here is the Maintainer
...
let colors_name = "monokai_of_mine"
...
let s:lightergrey = { "gui": "#9e9e9e", "cterm": "247" }
...
" This is so far the only change to the original: I find comments too dark
"   (which I like IRL but not on VIM)
"call s:h("Comment",       { "fg": s:warmgrey, "format": "italic" })
call s:h("Comment",       { "fg": s:lightergrey, "format": "italic" })
